...
\begin{figure}[htbp]
\centering
\includegraphics[height=7cm]{Pictures/ann_model_1.png}
\caption{ANN Model}
\label{}
\end{figure}
...
\multirow{\textbf{Algorithms}} & \textbf{} & \textbf{Precesion} & \textbf{Recall} & \textbf{F-Score} \\ \cline{2-5} 
...
\begin{figure}[htbp]
\centering
    \subfigure[]{\label{fig:adam_model_accuracy}\includegraphics[width=0.49\linewidth]{adam_model_accuracy.png}}
    \subfigure[]{\label{fig:sgd_model_accuracy}\includegraphics[width=0.49\linewidth]{sgd_model_accuracy.png}} 
    \\
    \subfigure[]{\label{fig:adagrad_model_accuracy}\includegraphics[width=0.49\linewidth]{adagrad_model_accuracy.png}}
    \subfigure[]{\label{fig:adadelta_model_accuracy}\includegraphics[width=0.49\linewidth]{adadelta_model_accuracy.png}} 
...
\begin{figure}[htbp]
\centering
    \subfigure[]{\label{fig:adam_model_loss}\includegraphics[width=0.49\linewidth]{adam_model_loss.png}}
    \subfigure[]{\label{fig:sgd_model_loss}\includegraphics[width=0.49\linewidth]{sgd_model_loss.png}} 
    \\
    \subfigure[]{\label{fig:adagrad_model_loss}\includegraphics[width=0.49\linewidth]{adagrad_model_loss.png}}
    \subfigure[]{\label{fig:adadelta_model_loss}\includegraphics[width=0.49\linewidth]{adadelta_model_loss.png}} 
  \label{model loss}
